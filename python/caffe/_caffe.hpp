...
class PyNet {
 public:
  ...
  void set_input_sparse_arrays(bp::object data_obj, bp::object indices_obj, bp::object ptr_obj, int rows, int cols, bp::object labels_obj);
 ...
 protected:
  ...
  bp::object input_indices_;
  bp::object input_ptr_;
};
